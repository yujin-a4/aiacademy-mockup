...
/* ⚠️ Part 5 구버전 수업 (아카이브) — 기존 콘텐츠 기록용.
   도입(Screen0)을 구버전(Screen0Legacy)으로 렌더. 새 버전은 /part5. */
...
export default function Part5LegacyPage() {
  ...
  return <LessonRouter onEnd={handleEnd} legacyIntro />
}
